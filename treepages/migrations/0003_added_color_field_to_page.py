...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.associated_color'
        db.add_column('treepages_page', 'associated_color', orm['treepages.page:associated_color'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Page.associated_color'
        db.delete_column('treepages_page', 'associated_color')
