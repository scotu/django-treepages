...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('treepages_page', 'created', orm['treepages.page:created'])
        
        # Adding field 'Page.modified'
        db.add_column('treepages_page', 'modified', orm['treepages.page:modified'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('treepages_page', 'created')
        
        # Deleting field 'Page.modified'
        db.delete_column('treepages_page', 'modified')
